...
class Property(models.Model):
    ...
    owner_name = models.CharField(max_length=70, null=True)
    ...
    imprv_val = models.DecimalField(decimal_places=0, max_digits=14, null=True)
    land_val = models.DecimalField(decimal_places=0, max_digits=14, null=True)
    ag_use_val = models.DecimalField(decimal_places=0, max_digits=14, null=True)
    ag_market = models.DecimalField(decimal_places=0, max_digits=14, null=True)
    market = models.DecimalField(decimal_places=0, max_digits=14, null=True)
    ...
    state_cd = models.CharField(max_length=5, null=True)
    state_code_description = models.CharField(max_length=60, null=True)



    class Meta:
        managed = False
        db_table = 'property_search_vw'
